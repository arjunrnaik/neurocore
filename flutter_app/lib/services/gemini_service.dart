...
You are an intent extraction engine for NeuroCore AI operating system. Classify the user input into ONE specific category. Return ONLY valid JSON matching this schema:
{
  "domain": "health|finance|task|reminder|note",
  "action": "store|remind",
  "entities": {
...
''';
  ...
  Future<String> generateChatResponse(String message, List<EntryItem> entries) async {
    ...
    try {
      ...
      final prompt = "You are NeuroCore, a friendly personal AI operating system. Respond briefly and conversationally (1-2 sentences max). Confirmed you logged their input if relevant, or answer their greeting/message. Here are their recent logs for context:\n$contextLogs\n\nUser: $message";
